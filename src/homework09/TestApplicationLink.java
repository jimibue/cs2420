...
import homework09.SimpleHashSetLinked.TableFullException;
 ...
 * @version 5/10/14
 */
public class TestApplicationLink
{
    ...
    public static void main (String[] args)
    {
        ...
        SimpleHashSetLinked set = new SimpleHashSetLinked (setCapacity,elementCount);
...
//                break;
	...
	System.out.println ();
       ...
       for(int i =0; i<set.llSize.length; i++)
       {
    	   System.out.println(set.llSize[i].size());
       }
    }
