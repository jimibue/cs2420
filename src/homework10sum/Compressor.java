 ...
 * no file access needs to be done during compression or decompression.<p>
 * 
 ...
 * or static variables in the implementing Compressor class.<p>
 * 
...
public interface Compressor
{
    ...
    /**
     * This method returns a short string that indicates the type of compression
     * that this compressor uses.  The string should be kept short, it will be stored
     * in archive files.
     *
