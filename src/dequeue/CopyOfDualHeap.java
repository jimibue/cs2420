...
public class CopyOfDualHeap<T extends Comparable<T>> {

	private List<Item> minHeap, maxHeap;
	private int comparisonCount;

	public CopyOfDualHeap() {
	...
	public T removeMax() {
		...
		// check parent, special case if it is 0 then it does not have a parent
//		if (replacement.minIndex == 0)// might not need this
//		{
//			System.out.println((replacement.minIndex - 1) / 2);
//			System.out.println("I don't think this excutes");
...
//			return replacement.getData();
	 ...
	 * minHeap and maxHeap are repectively following the heap property, will re
	 * 
