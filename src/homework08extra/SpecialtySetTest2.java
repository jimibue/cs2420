 ...
 * @version 2/22/2014
 */
public class SpecialtySetTest2
{
    ...
    public void test03 ()
    {
        ...
        SpecialtySet1<TrackedInteger> s = new SpecialtySet1<TrackedInteger>();
        ...
        System.out.println (TrackedInteger.comparisonCount+" yoyo"); 
        assertTrue ("Maximum comparison count test: ", TrackedInteger.comparisonCount <= 65536);
    ...
    TrackedInteger.comparisonCount =0;
      SpecialtySet<Integer> s = new SpecialtySet<Integer>();
      		s.add(0);s.add(1);s.add(3);s.add(5);s.add(4);s.add(6);
        	s.add(-1);s.add(7);
    ...
    public void test12 ()
    {
        ...
        //1500 for contains
       assertTrue ("Maximum comparison count test: ", TrackedInteger.comparisonCount <=8000);
       ...
       assertTrue ("Maximum comparison count test: ", TrackedInteger.comparisonCount <= 3400);
	        assertEquals("should be 0 ", 0, s.size());
    ...
    public void test13 ()
    {
       ...
       // System.out.println("test13 part a  comparison count " +ti.comparisonCount); 
        ...
        assertTrue ("Maximum comparison count test: ", TrackedInteger.comparisonCount <=600);
