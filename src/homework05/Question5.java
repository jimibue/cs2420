package homework05;
/**
 * this class contains methods and code to perform experiments for Question 2
 * 
 * 
 * @author James Yeates
 *
...
public class Question5 {
	...
	public void doExpriment5b()
	{
		...
		//this first loop controls the size of the array
			...
			for(int j = 0; j< tries; j++)
			{
				double [] arrayOfDoubles=createRandomArray(1000000);
            ...
            System.out.print ("\t");
            System.out.println (comparisonCounter * 1.0 / tries);
            System.out.println ((endTime1-startTime1)/1000.0);
            System.out.print (((totalTime)/1000.0));
            System.out.println ();
		}
	...
	public  void quicksortSubArray(double []d, int start, int end)
	{
		...
		else if(end - start<7)//size of array is 8 or less use insertion sort
